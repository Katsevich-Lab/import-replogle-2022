...
# Rscript create_sceptre_object_rd7_5.R # create the ondisc-backed sceptre_object
# Rscript create_sceptre_object_kd6_5.R # create the ondisc-backed sceptre_object
